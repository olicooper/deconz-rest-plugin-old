...
const quint64 osramMacPrefix      = 0x8418260000000000ULL; // Plugs
const quint64 osram2MacPrefix     = 0x000D6F0000000000ULL; // Switches
const quint64 osram3MacPrefix     = 0x7CB03E0000000000ULL; // Lights
